<%@ Page Language="C#" MasterPageFile="~/Pyaris.master" AutoEventWireup="true" CodeFile="404.aspx.cs" Inherits="_404" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="midpart" class="container">
        <div class="row spark-over-container">
            <div class="category-card-heading">404 - Page Not Found</div>
