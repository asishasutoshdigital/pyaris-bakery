...
/// <summary>
///     Summary description for randompin
/// </summary>
public class Randompin
{
    // Define default min and max password lengths.
    private static readonly int DEFAULT_MIN_PASSWORD_LENGTH = 20;
    private static readonly int DEFAULT_MAX_PASSWORD_LENGTH = 20;
    ...
    private static readonly string PASSWORD_CHARS_UCASE = "9513748620";
