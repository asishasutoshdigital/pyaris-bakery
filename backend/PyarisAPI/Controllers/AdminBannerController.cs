...
namespace PyarisAPI.Controllers
{
    ...
    public class AdminBannerController : ControllerBase
    {
        ...
        public AdminBannerController(IConfiguration configuration, ILogger<AdminBannerController> logger)
        {
        ...
        public ActionResult<object> Get()
        {
            ...
            return Ok(new { controller = "AdminBannerController", message = "Admin endpoint" });
        }
