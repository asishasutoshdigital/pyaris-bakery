...
namespace PyarisAPI.Controllers
{
    ...
    public class AdminBillingController : ControllerBase
    {
        ...
        public AdminBillingController(IConfiguration configuration, ILogger<AdminBillingController> logger)
        {
        ...
        public ActionResult<object> Get()
        {
            ...
            return Ok(new { controller = "AdminBillingController", message = "Admin endpoint" });
        }
