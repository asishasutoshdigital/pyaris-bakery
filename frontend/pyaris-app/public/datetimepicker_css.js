...
var WeekHeadColor = "#f6445d"; //var WeekHeadColor="#18861B";//Background Color in Week header.
...
var TodayColor = "#f6445d"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#FFFFFF"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor = "#cc0033"; //color of font of Year selector.
var MthSelColor = "#cc0033"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#f6445d"; //color when mouse move over.
var DisableColor = "#c5c5c5"; //color of disabled cell.
